...
* A computer setup with Neovim (a good breakdown of the differences can be found [here](https://neovim.io/doc/user/vim_diff.html) and a guide on how to install found [here](https://github.com/neovim/neovim/wiki/Installing-Neovim) )
* Neovim package installed from python [following the guide from here](https://github.com/neovim/python-client)
* A recent version of Node (At the time of this guide, Node was at v4.5.0 for LTS and 6.5.0 for current, but anything recent should work)
* A basic knowledge of how to configure Neovim
